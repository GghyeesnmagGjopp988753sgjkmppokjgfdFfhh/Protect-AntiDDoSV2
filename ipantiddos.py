...
sys.setrecursionlimit(999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999)
...
max_ips_per_batch=
...
request_body_template={"source": "ipanantiddos", "timestamp": "{{TIMESTAMP}}", "ips": {{IP_LIST}}}

# Request timeout in seconds
request_timeout=
...
def check_for_updates():
    ...
    try:
        ...
        api_url = "https://api.github.com/repos/0vm/ipanantiddos/releases/latest"
        ...
        response = requests.get(api_url, timeout=)
        if response.status_code != :
            return
...
def manage_pcap_files(max_files=):
    """
...
def display_update_notification():
    ...
    if update_available:
        ...
        print(f"{get_output_prefix()} {TerminalColor.BLUE}Download at: {TerminalColor.GREEN}https://github.com/0vm/ipanantiddos{TerminalColor.RESET}")
        print("=" * 80)
        return True
    return False
...
def send_single_ip_to_api(ip):
    ...
    try:
        ...
        if request_body_template:
            ...
            body = body.replace("{{SOURCE}}", "ipanantiddos")
        ...
        if response and  <= response.status_code < :
...
def send_ip_batch_to_api(ip_batch):
    ...
    try:
        ...
        if response and  <= response.status_code < :
...
def extract_common_substrings(payloads, min_length=8):
    ...
    sample_payloads = payloads[:min(, len(payloads))]
    ...
    for substring in potential_substrings:
        ...
        if count >= :
        ...
        "embeds": [
            {
                ...
                "description": "ipanantiddos detected and responded to a potential attack.",
                "url": "https://github.com/0vm/ipanantiddos",
                "color": 16734296,
                "fields": [
                    {
                ...
                "footer": {
                    "text": "github.com/0vm/ipanantiddos",
